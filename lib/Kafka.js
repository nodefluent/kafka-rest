...
class Kafka {
  ...
  async getConsumer(name, topics = [], earliestElseLatest = false, maxWindowSize = 1000, messageFormat){
    ...
    consumer.on("message", message => this.config.logger.info("kafka message", message));
